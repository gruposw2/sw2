<%-- 
    ...
    Created on : 26/09/2013, 10:18:40 PM
    Author     : Marco
--%>
...
<html>
    ...
    <body>
         ...
         <div class="container">
                <br>
                <div align="right">
                                <A href="VistaAdministrador.jsp"><span style="font-size: 20px; line-height: normal;color: #4791C3; font-family: Segoe UI Light;  ">Cuenta (Administrador)</span></A>
				<font color="#4791C3" size="5" face="Segoe UI Light">|</font>
                                <A href="../index.jsp"><span style="font-size: 20px; line-height: normal;color: #4791C3; font-family: Segoe UI Light;  ">Cerrar Sesión</span></A>
		...
		<div align="center" >
		<font color="#4791C3" size="10" face="Segoe UI Light">Crear Usuario</font>
		</div>
		...
		<br><br>
			...
			<form class="usuarios">
				...
				<button type="submit" class="btn btn-large btn-primary">Registrar usuario</button>
